...
.. tabs::
    ...
    .. group-tab:: Using CLI
        ...
        .. code::
            ...
            ssh -i <privateKey> -o ProxyCommand="ssh -i <privateKey> -W %h:%p -p 22 ocid1.bastionsession.oc1.sa-saopaulo-1.amaaaaaaniwq6syaw7chyowsp55ksemkz67khnd3kprlmwceezuiqe74w4pq@host.bastion.sa-saopaulo-1.oci.oraclecloud.com" -p 22 ubuntu@10.0.1.230
